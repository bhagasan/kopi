...
<section class="section-detail-headline panel bg-brown">
  <div class="section-detail-headline-container">
    <div class="section-detail-headline-scene">
      <img id="headline_tiramisu" data-depth="0.10" src="assets/images/detail-tiramius-headline-tiramisu.png" alt="">
      <img id="headline_caramel_kopi" data-depth="0.30" src="assets/images/detail-tiramisu-headline-biji.png" alt="">
      <img id="headline_cloud" src="assets/images/detail-tiramisu-headline-coud.png" alt="">
    </div>
  </div>
  <div class="img-sobek-container">
    ...
    <img id="sachet_b" src="assets/images/detail-tiramisu-sachet-b.png" alt="">
  </div>
...
<section class="bg-yellow row no-gutters align-items-center justify-content-center">
  <div class="container-fluid">
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="glass-container">
          <img id="mocha_hand" class="" src="assets/images/kopi-tangan-tiramisu.png" alt="">
...
<section class="panel bg-brown mobile-auto-height">
  <img class="w-100 mt-5" src="assets/images/tiramisu-people.png" alt="">
</section>
